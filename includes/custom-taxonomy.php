...
if ( ! function_exists( 'core_issues_taxonomy' ) ) {
   ...
   * @return void
   */
  function core_issues_taxonomy() {

    $labels = array(
      'name'                       => _x( 'Issues', 'Taxonomy General Name', 'core-functionality' ),
      'singular_name'              => _x( 'Issue', 'Taxonomy Singular Name', 'core-functionality' ),
      'menu_name'                  => __( 'Issues', 'core-functionality' ),
      'all_items'                  => __( 'All Issues', 'core-functionality' ),
      'parent_item'                => __( 'Parent Issue', 'core-functionality' ),
      'parent_item_colon'          => __( 'Parent Issue:', 'core-functionality' ),
      'new_item_name'              => __( 'New Issue Name', 'core-functionality' ),
      'add_new_item'               => __( 'Add New Issue', 'core-functionality' ),
      'edit_item'                  => __( 'Edit Issue', 'core-functionality' ),
      'update_item'                => __( 'Update Issue', 'core-functionality' ),
      'view_item'                  => __( 'View Issue', 'core-functionality' ),
      ...
      'popular_items'              => __( 'Popular Issues', 'core-functionality' ),
      'search_items'               => __( 'Search Issues', 'core-functionality' ),
      'not_found'                  => __( 'Not Found', 'core-functionality' ),
      'no_terms'                   => __( 'No items', 'core-functionality' ),
      'items_list'                 => __( 'Issues list', 'core-functionality' ),
      'items_list_navigation'      => __( 'Issues list navigation', 'core-functionality' ),
      'back_to_items'              => __( '&larr; Back to Issues', 'core-functionality' ),
    );
  ...
  add_action( 'init', 'core_issues_taxonomy', 0 );
...
if ( ! function_exists( 'core_language_taxonomy' ) ) {
  ...
  function core_language_taxonomy() {
    ...
    register_taxonomy( 'language', array( 'post', 'page', 'campaign', 'kbe_knowledgebase', 'knowledge-base', 'event', 'event-recurring' ), $args );
...
if ( ! function_exists( 'core_campaign_taxonomy' ) ) {
  ...
  function core_campaign_taxonomy() {
    ...
    register_taxonomy( 'campaign-category', array( 'post', 'campaign', 'page' ), $args );
...
// if ( ! function_exists( 'core_program_taxonomy' ) ) {
//
//   // Register Custom Taxonomy
//   function core_program_taxonomy() {
//
//   	$labels = array(
//   		'name'                       => _x( 'Program Categories', 'Taxonomy General Name', 'core-functionality' ),
//   		'singular_name'              => _x( 'Category', 'Taxonomy Singular Name', 'core-functionality' ),
//   		'menu_name'                  => __( 'Program Categories', 'core-functionality' ),
//   		'all_items'                  => __( 'All Programs', 'core-functionality' ),
//   		'parent_item'                => __( 'Parent Program', 'core-functionality' ),
//   		'parent_item_colon'          => __( 'Parent Program:', 'core-functionality' ),
//   		'new_item_name'              => __( 'New Program Name', 'core-functionality' ),
...
//   		'add_or_remove_items'        => __( 'Add or remove items', 'core-functionality' ),
//   		'choose_from_most_used'      => __( 'Choose from the most used', 'core-functionality' ),
//   		'popular_items'              => __( 'Popular Programs', 'core-functionality' ),
//   		'search_items'               => __( 'Search Programs', 'core-functionality' ),
//   		'not_found'                  => __( 'Not Found', 'core-functionality' ),
//   		'no_terms'                   => __( 'No items', 'core-functionality' ),
...
//   		'show_in_rest'               => true,
//   	);
//   	register_taxonomy( 'program-category', array( 'program', 'event', 'event-recurring' ), $args );
//
//   }
//   add_action( 'init', 'core_program_taxonomy', 0 );
//
// }
