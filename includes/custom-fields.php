...
function core_register_post_meta() {
	...
	register_post_meta( '', 'translated_title', $args );
}
...
if( function_exists( 'acf_add_local_field_group' ) ) {
  ...
  acf_add_local_field_group( array(
  	...
  	'fields' => array(
  		...
  		array(
  			...
  			'label' => __( 'Sub-title', 'core-functionality' ),
  			'name' => 'subtitle',
  			'type' => 'text',
  			'instructions' => '',
  			'required' => 0,
  	...
  	/* Posts Generally */
	// acf_add_local_field_group(array(
	// 	'key' => 'group_5c5b638e5481f',
	// 	'title' => __( 'Translation', 'core-functionality' ),
	// 	'fields' => array(
	// 		array(
	// 			'key' => 'field_5c5b63e35dab9',
	// 			'label' => __( 'Translated Title', 'core-functionality' ),
	// 			'name' => 'translated_title',
	// 			'type' => 'text',
	// 			'instructions' => __( 'If this post is a translation, please enter the non-English title.', 'core-functionality' ),
	// 			'required' => 0,
	// 			'conditional_logic' => 0,
	// 			'wrapper' => array(
	// 				'width' => '',
	...
	/* Tenant Issues */
	acf_add_local_field_group( array(
		'key' => 'group_issue_taxonomy',
		'title' => __( 'Issue Details', 'core-functionality' ),
		'fields' => array(
			array(
				'key' => 'field_date',
				'label' => __( 'Date', 'core-functionality' ),
				'name' => 'date',
				'type' => 'date_picker',
				'instructions' => '',
				'required' => 0,
			...
			array(
				'key' => 'field_file',
				'label' => __( 'File', 'core-functionality' ),
				'name' => 'file',
				'type' => 'file',
				'instructions' => '',
				'required' => 0,
  ...
  /* Gutenberg Settings */
//   acf_add_local_field_group( array(
//   	'key' => 'group_5bf46bdd55634',
//   	'title' => __( 'Gutenberg Settings', 'core-functionality' ),
//   	'fields' => array(
//   		array(
//   			'key' => 'field_5bf46c0170682',
//   			'label' => __( 'Enable Gutenberg', 'core-functionality' ),
...
//   ));
  ...
  /* Program Category - Replace Default Metabox with Single Select Field */
  // acf_add_local_field_group(array(
  // 	'key' => 'group_5bddfa018d4ac',
  // 	'title' => __( 'Program Category', 'core-functionality' ),
  // 	'fields' => array(
  // 		array(
  // 			'key' => 'field_5bddfa0195331',
  // 			'label' => __( 'Program Category', 'core-functionality' ),
  ...
  // ));
	...
	/* Help & Answers */
	// acf_add_local_field_group(array(
	// 	'key' => 'group_5c5b5c5646bad',
	// 	'title' => __( 'Intro', 'core-functionality' ),
	// 	'fields' => array(
	// 		array(
	// 			'key' => 'field_5c5b5c5c64071',
	// 			'label' => __( 'Title', 'core-functionality' ),
	// 			'name' => 'intro_title',
	// 			'type' => 'text',
	// 			'instructions' => '',
...
// acf_add_local_field_group( array(
// 	'key' => 'group_5ba3ffa0c3pea3',
// 	'title' => __( 'Summary', 'core-functionality' ),
// 	'fields' => array(
// 		array(
// 			'key' => 'field_5ba3ffdfa3c0x0',
// 			'label' => __( 'Title', 'core-functionality' ),
// 			'name' => 'summary_title',
// 			'type' => 'text',
// 			'instructions' => '',
...
//   ));
  	...
  	'fields' => array(
  		array(
  			...
  			'layouts' => array(
  				...
  				// 'layout_5bbbcfe8a00b8' => array(
  				// 	'key' => 'layout_5bbbcfe8a00b8',
  				// 	'name' => 'campaigns',
  				// 	'label' => __( 'Campaigns', 'core-functionality' ),
  				// 	'display' => 'row',
  				// 	'sub_fields' => array(
  				// 		array(
  				// 			'key' => 'field_5bbbcff1a00b9',
  				// 			'label' => __( 'Title', 'core-functionality' ),
  				// 			'name' => 'title',
  				// 			'type' => 'text',
  				// 			'instructions' => '',
  				...
  				// 			'max' => 0,
  				// 			'layout' => 'row',
  				// 			'button_label' => __( 'Add Campaign', 'core-functionality' ),
  				// 			'sub_fields' => array(
  				// 				array(
  				// 					'key' => 'field_5bbbd03da00bb',
  				// 					'label' => __( 'Title', 'core-functionality' ),
  				// 					'name' => 'title',
  				// 					'type' => 'text',
  				// 					'instructions' => '',
  				...
  				// 				),
  				// 				array(
  				// 					'key' => 'field_5bc7a07914ba1',
  				// 					'label' => __( 'Subtitle', 'core-functionality' ),
  				// 					'name' => 'subtitle',
  				// 					'type' => 'text',
  				// 					'instructions' => '',
  				// 					'required' => 0,
  				...
  				// 				),
  				// 				array(
  				// 					'key' => 'field_5bbbe473be28d',
  				// 					'label' => __( 'Campaign', 'core-functionality' ),
  				// 					'name' => 'link',
  				// 					'type' => 'relationship',
  				// 					'instructions' => __( 'Select the related campaign.', 'core-functionality' ),
  				// 					'required' => 1,
  				// 					'conditional_logic' => 0,
  				// 					'wrapper' => array(
  				// 						'width' => '',
  ...
  /* Staff */
//   acf_add_local_field_group(array(
//   	'key' => 'group_5b9f29594ede4',
//   	'title' => __( 'Staff', 'core-functionality' ),
//   	'fields' => array(
//   		array(
//   			'key' => 'field_5b9f296341be2',
//   			'label' => __( 'Title', 'core-functionality' ),
//   			'name' => 'title',
//   			'type' => 'text',
//   			'instructions' => '',
...
//   		),
//   		array(
//   			'key' => 'field_5b9f297a41be4',
//   			'label' => __( 'Phone', 'core-functionality' ),
//   			'name' => 'phone',
//   			'type' => 'text',
//   			'instructions' => '',
//   			'required' => 0,
